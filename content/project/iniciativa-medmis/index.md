...
summary: >-
  La Iniciativa MedMIS fue un proyecto pionero en el monitoreo y asistencia de
  especies marinas invasoras en espacios marinos protegidos del Mediterráneo
  (AMPs). Las especies invasoras representan una de las mayores amenazas para la
  biodiversidad en las áreas marinas protegidas y en el mar Mediterráneo. A
  continuación, presento un resumen de mi experiencia trabajando en este
  proyecto y su relevancia para la conservación marina.
  ...
  Puedes encontrar más información sobre el proyecto en los siguientes enlaces: 


  * [W﻿eb de IUCN](https://www.iucn.org/our-work/region/mediterranean/our-work/biodiversity-knowledge-and-action/eicat-invasive-species)

  * Aquí hay un ejemplo de una ficha de identificación de una especie marina invasora (añadir enlace a la ficha o imagen).

  * Para más ejemplos de mapas y datos recopilados en MedMIS, puedes visitar la sección de mapas de la plataforma (añadir enlace a la sección de mapas).
